...
class Workouts {
    ...
    private func loadData() {
        ...
        if let data = defaults.data(forKey: WORKOUTS_KEY) {
            ...
            case "en":
                let plistURL = Bundle.main.url(forResource: "FullWorkoutsEn", withExtension: "plist")!
    ...
    func getCurrentWorkout() -> Workout {
        ...
        return Workout(duration: nil, name: "Вы закончили!".localized())
    }
    ...
    func getNextWorkout() -> Workout {
        ...
        return Workout(duration: nil, name: "Последний рывок!".localized())
    }
