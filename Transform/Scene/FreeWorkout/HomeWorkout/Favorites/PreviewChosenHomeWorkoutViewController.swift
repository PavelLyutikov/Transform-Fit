//
//  PreviewChosenHomeWorkoutViewController.swift
//  Transform
//
...
class PreviewChosenHomeWorkoutViewController: UIViewController {
...
//MARK: - Button
    ...
    @objc func actionNextButton(sender: UIButton) {
        ...
        if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteHomeWorkoutOne") {
                    viewOne.fadeLeft()
                ...
                if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteHomeWorkoutTwo") {
                    ...
                    Timer.scheduledTimer(withTimeInterval: 0.3, repeats: false) { (timer) in
                        ...
                        if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteHomeWorkoutThree") {
                           ...
                           UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteHomeWorkoutThree")
                    
                   }
                   UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteHomeWorkoutTwo")
           }
           UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteHomeWorkoutOne")
...
//MARK: - OneScreen
    ...
    lazy var imageOne: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "previewChosenHomeWorkoutOne"
        case "en":
            nameImage = "previewChosenHomeWorkoutOneEn"
        default:
            nameImage = "previewChosenHomeWorkoutOneEn"
        }
...
//MARK: - TwoScreen
    ...
    lazy var labelTwo: UILabel = {
        ...
        let lbl = UILabel()
        lbl.text = "Чтобы добавить упражнение, зайди в нужную группу мышц и свайпни упражнение, которое понравилось".localized()
        lbl.textColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
        lbl.font = UIFont.systemFont(ofSize: 24)
        lbl.numberOfLines = 0
        lbl.textAlignment = .center
    ...
    lazy var imageTwo: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "previewChosenHomeWorkoutTwo"
        case "en":
            nameImage = "previewChosenHomeWorkoutTwoEn"
        default:
            nameImage = "previewChosenHomeWorkoutTwoEn"
        }
...
//MARK: - ThreeScreen
    ...
    lazy var imageThree: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "previewChosenHomeWorkoutThree"
        case "en":
            nameImage = "previewChosenHomeWorkoutThreeEn"
        default:
            nameImage = "previewChosenHomeWorkoutThreeEn"
        }
...
//MARK: - FourScreen
    ...
    lazy var imageFour: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "previewChosenHomeWorkoutFour"
        case "en":
            nameImage = "previewChosenHomeWorkoutFourEn"
        default:
            nameImage = "previewChosenHomeWorkoutFourEn"
        }
