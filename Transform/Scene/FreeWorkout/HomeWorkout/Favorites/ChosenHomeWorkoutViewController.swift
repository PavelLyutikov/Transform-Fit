...
//  Transform
//
//  Created by Pavel Lyutikov on 14.05.2021.
//
...
class ChosenHomeWorkoutViewController: UIViewController {
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ChosenHomeWorkoutViewController.videoReady), name: NSNotification.Name(rawValue: "videoReadyWorkout"), object: nil)
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func nextWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "openNextHomeWorkout")
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func backWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(false, forKey: "isOpenHomeWorkout")
        UserDefaults.standard.set(true, forKey: "openBackHomeWorkout")
...
extension ChosenHomeWorkoutViewController: ISBannerDelegate, ISImpressionDataDelegate {
