...
class YogaViewController: UIViewController {
    ...
    var integ = UserDefaults.standard.integer(forKey: "interstitialYoga")
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
        ...
        //TimedOutAlert
        NotificationCenter.default.addObserver(self, selector: #selector(YogaViewController.videoReady), name: NSNotification.Name(rawValue: "videoReady"), object: nil)
        ...
        if !UserDefaults.standard.bool(forKey: "removeAdsPurchased") {
            ...
            if integ >= 5 {
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                    ...
                    UserDefaults.standard.set(self.integ, forKey: "interstitialYoga")
                }
            } else {
                integ += 1
                UserDefaults.standard.set(integ, forKey: "interstitialYoga")
            }
        }
    }
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func nextWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "openNextYogaAsan")
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func backWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(false, forKey: "isOpenYoga")
        UserDefaults.standard.set(true, forKey: "openBackYogaAsan")
...
extension YogaViewController: ISBannerDelegate, ISImpressionDataDelegate, ISInterstitialDelegate {
