...
class StretchingViewController: UIViewController {
    ...
    var integ = UserDefaults.standard.integer(forKey: "interstitialStretching")
...
//        self.view.backgroundColor = .white
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(StretchingViewController.videoReady), name: NSNotification.Name(rawValue: "videoReadyStretching"), object: nil)
        ...
        if !UserDefaults.standard.bool(forKey: "removeAdsPurchased") {
            ...
            if integ >= 5 {
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                    ...
                    self.integ = 0
                    UserDefaults.standard.set(self.integ, forKey: "interstitialStretching")
                }
            } else {
                integ += 1
                UserDefaults.standard.set(integ, forKey: "interstitialStretching")
            }
        }
    }
//MARK: - IronSource
...
//            stretchingVideoPlayer.playerPause()
//
//            buttonPlay.isHidden = false
//            buttonPlay.addTarget(self, action: #selector(buttonPlayAction(sender:)), for: .touchUpInside)
...
//    }()
//    
//    @objc func buttonPlayAction(sender: UIButton) {
//
//        guard let videoUrl = URL(string: stretching!.video) else { return }
//        
//        URLSession.shared.dataTask(with: videoUrl) { [weak self] (data, response, error) in
...
//        }.resume()
//        
//        stretchingVideoPlayer.playerPlay()
//        
//        buttonPlay.zoomOutInfo()
//        buttonPlay.isHidden = true
//    
//        Timer.scheduledTimer(withTimeInterval: 0.3, repeats: false) { (timer) in
//            self.buttonPause.zoomInInfo()
//            self.buttonPause.isHidden = false
//            self.buttonPause.addTarget(self, action: #selector(self.buttonPauseAction(sender:)), for: .touchUpInside)
//        }
//    }
//
////MARK: - ButtonPause
...
//    }()
//    
//    @objc func buttonPauseAction(sender: UIButton) {
//        pauseIsActive = true
//        stretchingVideoPlayer.playerPause()
//        
//        buttonPause.zoomOutInfo()
//        buttonPause.isHidden = true
//    
//        Timer.scheduledTimer(withTimeInterval: 0.3, repeats: false) { (timer) in
//            self.buttonPlay.zoomInInfo()
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func nextWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "openNextStretchingWorkout")
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func backWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "openBackStretchingWorkout")
...
extension StretchingViewController: ISBannerDelegate, ISImpressionDataDelegate, ISInterstitialDelegate {
