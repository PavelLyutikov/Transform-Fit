//
//  PreviewChosenRecoveryViewController.swift
//  Transform
//
...
class PreviewChosenRecoveryViewController: UIViewController {
...
//MARK: - Button
    ...
    @objc func actionNextButton(sender: UIButton) {
        ...
        if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteRecoveryOne") {
                    viewOne.fadeLeft()
                ...
                if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteRecoveryTwo") {
                    ...
                    Timer.scheduledTimer(withTimeInterval: 0.3, repeats: false) { (timer) in
                        ...
                        if !UserDefaults.standard.bool(forKey: "isFirstPressButtonFavoriteRecoveryThree") {
                           ...
                           UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteRecoveryThree")
                    
                   }
                   UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteRecoveryTwo")
           }
           UserDefaults.standard.set(true, forKey: "isFirstPressButtonFavoriteRecoveryOne")
...
//MARK: - OneScreen
    ...
    lazy var imageOne: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "recoveryChosenPreviewOne"
        case "en":
            nameImage = "recoveryChosenPreviewOneEn"
        default:
            nameImage = "recoveryChosenPreviewOneEn"
        }
...
//MARK: - TwoScreen
    ...
    lazy var imageTwo: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "recoveryChosenPreviewTwo"
        case "en":
            nameImage = "recoveryChosenPreviewTwoEn"
        default:
            nameImage = "recoveryChosenPreviewTwoEn"
        }
...
//MARK: - ThreeScreen
    ...
    lazy var imageThree: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "recoveryChosenPreviewThree"
        case "en":
            nameImage = "recoveryChosenPreviewThreeEn"
        default:
            nameImage = "recoveryChosenPreviewThreeEn"
        }
...
//MARK: - FourScreen
    ...
    lazy var imageFour: UIImageView = {
        ...
        switch Locale.current.languageCode {
        case "ru":
            nameImage = "recoveryChosenPreviewFour"
        case "en":
            nameImage = "recoveryChosenPreviewFourEn"
        default:
            nameImage = "recoveryChosenPreviewFourEn"
        }
