//
//  PostPregnancyRecoveryViewController.swift
//  Transform
//
...
class PostPregnancyRecoveryViewController: UIViewController {
    ...
    var integ = UserDefaults.standard.integer(forKey: "interstitialRecovery")
...
//        self.view.backgroundColor = .white
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(PostPregnancyRecoveryViewController.videoReady), name: NSNotification.Name(rawValue: "videoReadyPostPregnancyRecovery"), object: nil)
        ...
        if !UserDefaults.standard.bool(forKey: "removeAdsPurchased") {
            ...
            if integ >= 5 {
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                    ...
                    self.integ = 0
                    UserDefaults.standard.set(self.integ, forKey: "interstitialRecovery")
                }
            } else {
                integ += 1
                UserDefaults.standard.set(integ, forKey: "interstitialRecovery")
            }
        }
    }
//MARK: - IronSource
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func nextWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(true, forKey: "openNextPostPregnancyRecoveryWorkout")
...
//        btn.adjustsImageWhenHighlighted = false
    ...
    @objc func backWorkoutButtonAction(sender: UIButton) {
        ...
        UserDefaults.standard.set(false, forKey: "isOpenRecovery")
        UserDefaults.standard.set(true, forKey: "openBackPostPregnancyRecoveryWorkout")
...
extension PostPregnancyRecoveryViewController: ISBannerDelegate, ISImpressionDataDelegate, ISInterstitialDelegate {
