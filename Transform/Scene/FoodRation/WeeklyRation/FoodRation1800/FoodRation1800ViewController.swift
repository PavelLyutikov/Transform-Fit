//
//  FoodRation1800ViewController.swift
//  Transform
//
//  Created by Pavel Lyutikov on 22.11.2021.
//
...
class FoodRation1800ViewController: UIViewController, UIScrollViewDelegate {
    ...
    var foodRation1800_purchased: Bool = false
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
            ...
            SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
                ...
                case .success(let receipt):
                    ...
                    case .purchased(let receiptItem):
                        UserDefaults.standard.set(true, forKey: "foodRation1800_purchased")

                        self.foodRation1800_purchased = true
                        
                        print("\(productId) is purchased: \(receiptItem)")
                    case .notPurchased:
                        
                        self.buttonPurchaseFoodRation1800.addTarget(self, action: #selector(self.buttonPurchaseFoodRation1800(sender:)), for: .touchUpInside)
        ...
        //SuccessfulPurchase
        NotificationCenter.default.addObserver(self, selector: #selector(FoodRation1800ViewController.successfulPurchaseFoodRation1800), name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1800"), object: nil)
...
//MARK: - SuccessfulPurchase
    @objc func successfulPurchaseFoodRation1800() {
        
        buttonRestoredPurchase.zoomOutInfo()
        buttonPurchaseFoodRation1800.zoomOutInfo()
        
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
            self.buttonRestoredPurchase.isHidden = true
            self.buttonPurchaseFoodRation1800.isHidden = true
        }
    }
...
//MARK: - ButtonPurchase
    lazy var buttonPurchaseFoodRation1800: UIButton = {
        var width: CGFloat!
    ...
    @objc func buttonPurchaseFoodRation1800(sender: UIButton) {
        activityIndicator.startAnimating()
        
        SwiftyStoreKit.purchaseProduct("com.transform.fitness.foodRation1800", quantity: 1, atomically: true) { result in
            switch result {
            case .success(let purchase):
                
                UserDefaults.standard.set(true, forKey: "foodRation1800_purchased")
                
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1800"), object: nil)
...
//MARK: - ButtonMenu
    ...
    @objc func button1Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Monday")
    ...
    @objc func button2Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Tuesday")
    
        if !foodRation1800_purchased {
    ...
    @objc func button3Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Wednesday")
    ...
    @objc func button4Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Thursday")
    ...
    @objc func button5Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Friday")
    ...
    @objc func button6Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Saturday")
    ...
    @objc func button7Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1800Sunday")
