//
//  FoodRation1600ViewController.swift
//  Transform
//
//  Created by Pavel Lyutikov on 24.08.2021.
//
...
class FoodRation1600ViewController: UIViewController, UIScrollViewDelegate {
    ...
    var foodRation1600_purchased: Bool = false
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
            ...
            SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
                ...
                case .success(let receipt):
                    ...
                    case .purchased(let receiptItem):
                        UserDefaults.standard.set(true, forKey: "foodRation1600_purchased")

                        self.foodRation1600_purchased = true
                        
                        print("\(productId) is purchased: \(receiptItem)")
                    case .notPurchased:
                        
                        self.buttonPurchaseFoodRation1600.addTarget(self, action: #selector(self.buttonPurchaseFoodRation1600(sender:)), for: .touchUpInside)
        ...
        //SuccessfulPurchase
        NotificationCenter.default.addObserver(self, selector: #selector(FoodRation1600ViewController.successfulPurchaseFoodRation1600), name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1600"), object: nil)
...
//MARK: - SuccessfulPurchase
    @objc func successfulPurchaseFoodRation1600() {
        
        buttonRestoredPurchase.zoomOutInfo()
        buttonPurchaseFoodRation1600.zoomOutInfo()
        
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
            self.buttonRestoredPurchase.isHidden = true
            self.buttonPurchaseFoodRation1600.isHidden = true
        }
    }
...
//MARK: - ButtonPurchase
    lazy var buttonPurchaseFoodRation1600: UIButton = {
        var width: CGFloat!
    ...
    @objc func buttonPurchaseFoodRation1600(sender: UIButton) {
        activityIndicator.startAnimating()
        
        SwiftyStoreKit.purchaseProduct("com.transform.fitness.foodRation1600", quantity: 1, atomically: true) { result in
            switch result {
            case .success(let purchase):
                
                UserDefaults.standard.set(true, forKey: "foodRation1600_purchased")
                
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1600"), object: nil)
...
//MARK: - ButtonMenu
    ...
    @objc func button1Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Monday")
    ...
    @objc func button2Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Tuesday")
    
        if !foodRation1600_purchased {
    ...
    @objc func button3Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Wednesday")
        if !foodRation1600_purchased {
            showinfoRestoreAlert()
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                sender.zoomInInfo()
    ...
    @objc func button4Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Thursday")
    ...
    @objc func button5Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Friday")
    ...
    @objc func button6Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Saturday")
    ...
    @objc func button7Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1600Sunday")
