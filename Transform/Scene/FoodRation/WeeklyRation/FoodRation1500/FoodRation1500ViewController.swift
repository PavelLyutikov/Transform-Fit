//
//  FoodRation1500ViewController.swift
//  Transform
//
//  Created by Pavel Lyutikov on 27.07.2021.
//
...
class FoodRation1500ViewController: UIViewController, UIScrollViewDelegate {
    ...
    var foodRation1500_purchased: Bool = false
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
            ...
            SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
                ...
                case .success(let receipt):
                    ...
                    case .purchased(let receiptItem):
                        UserDefaults.standard.set(true, forKey: "foodRation1500_purchased")

                        self.foodRation1500_purchased = true
                        
                        print("\(productId) is purchased: \(receiptItem)")
                    case .notPurchased:
                        
                        self.buttonPurchaseFoodRation1500.addTarget(self, action: #selector(self.buttonPurchaseFoodRation1500(sender:)), for: .touchUpInside)
        ...
        //SuccessfulPurchase
        NotificationCenter.default.addObserver(self, selector: #selector(FoodRation1500ViewController.successfulPurchaseFoodRation1500), name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1500"), object: nil)
...
//MARK: - SuccessfulPurchase
    @objc func successfulPurchaseFoodRation1500() {
        
        buttonRestoredPurchase.zoomOutInfo()
        buttonPurchaseFoodRation1500.zoomOutInfo()
        
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
            self.buttonRestoredPurchase.isHidden = true
            self.buttonPurchaseFoodRation1500.isHidden = true
        }
    }
...
//MARK: - ButtonPurchase
    lazy var buttonPurchaseFoodRation1500: UIButton = {
        var width: CGFloat!
    ...
    @objc func buttonPurchaseFoodRation1500(sender: UIButton) {
        activityIndicator.startAnimating()
        
        SwiftyStoreKit.purchaseProduct("com.transform.fitness.foodRation1500", quantity: 1, atomically: true) { result in
            switch result {
            case .success(let purchase):
                
                UserDefaults.standard.set(true, forKey: "foodRation1500_purchased")
                
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1500"), object: nil)
...
//MARK: - ButtonMenu
    ...
    @objc func button1Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Monday")
    ...
    @objc func button2Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Tuesday")
    
        if !foodRation1500_purchased {
    ...
    @objc func button3Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Wednesday")
        if !foodRation1500_purchased {
            showinfoRestoreAlert()
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                sender.zoomInInfo()
    ...
    @objc func button4Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Thursday")
    ...
    @objc func button5Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Friday")
    ...
    @objc func button6Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Saturday")
    ...
    @objc func button7Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1500Sunday")
