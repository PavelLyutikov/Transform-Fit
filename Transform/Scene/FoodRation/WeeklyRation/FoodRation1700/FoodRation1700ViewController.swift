//
//  FoodRation1700ViewController.swift
//  Transform
//
...
class FoodRation1700ViewController: UIViewController, UIScrollViewDelegate {
    ...
    var foodRation1700_purchased: Bool = false
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
            ...
            SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
                ...
                case .success(let receipt):
                    ...
                    case .purchased(let receiptItem):
                        UserDefaults.standard.set(true, forKey: "foodRation1700_purchased")

                        self.foodRation1700_purchased = true
                        
                        print("\(productId) is purchased: \(receiptItem)")
                    case .notPurchased:
                        
                        self.buttonPurchaseFoodRation1700.addTarget(self, action: #selector(self.buttonPurchaseFoodRation1700(sender:)), for: .touchUpInside)
        ...
        //SuccessfulPurchase
        NotificationCenter.default.addObserver(self, selector: #selector(FoodRation1700ViewController.successfulPurchaseFoodRation1700), name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1700"), object: nil)
...
//MARK: - SuccessfulPurchase
    @objc func successfulPurchaseFoodRation1700() {
        
        buttonRestoredPurchase.zoomOutInfo()
        buttonPurchaseFoodRation1700.zoomOutInfo()
        
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
            self.buttonRestoredPurchase.isHidden = true
            self.buttonPurchaseFoodRation1700.isHidden = true
        }
    }
...
//MARK: - ButtonPurchase
    lazy var buttonPurchaseFoodRation1700: UIButton = {
        var width: CGFloat!
    ...
    @objc func buttonPurchaseFoodRation1700(sender: UIButton) {
        activityIndicator.startAnimating()
        
        SwiftyStoreKit.purchaseProduct("com.transform.fitness.foodRation1700", quantity: 1, atomically: true) { result in
            switch result {
            case .success(let purchase):
                
                UserDefaults.standard.set(true, forKey: "foodRation1700_purchased")
                
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1700"), object: nil)
...
//MARK: - ButtonMenu
    ...
    @objc func button1Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Monday")
    ...
    @objc func button2Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Tuesday")
    
        if !foodRation1700_purchased {
    ...
    @objc func button3Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Wednesday")
        if !foodRation1700_purchased {
            showinfoRestoreAlert()
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                sender.zoomInInfo()
    ...
    @objc func button4Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Thursday")
    ...
    @objc func button5Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Friday")
    ...
    @objc func button6Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Saturday")
    ...
    @objc func button7Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1700Sunday")
