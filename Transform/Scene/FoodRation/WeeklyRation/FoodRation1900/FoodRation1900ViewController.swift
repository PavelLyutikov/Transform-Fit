//
//  FoodRation1900ViewController.swift
//  Transform
//
...
class FoodRation1900ViewController: UIViewController, UIScrollViewDelegate {
    ...
    var foodRation1900_purchased: Bool = false
...
//MARK: - viewDidLoad
    override func viewDidLoad() {
            ...
            SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
                ...
                case .success(let receipt):
                    ...
                    case .purchased(let receiptItem):
                        UserDefaults.standard.set(true, forKey: "foodRation1900_purchased")

                        self.foodRation1900_purchased = true
                        
                        print("\(productId) is purchased: \(receiptItem)")
                    case .notPurchased:
                        
                        self.buttonPurchaseFoodRation1900.addTarget(self, action: #selector(self.buttonPurchaseFoodRation1900(sender:)), for: .touchUpInside)
        ...
        //SuccessfulPurchase
        NotificationCenter.default.addObserver(self, selector: #selector(FoodRation1900ViewController.successfulPurchaseFoodRation1900), name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1900"), object: nil)
...
//MARK: - SuccessfulPurchase
    @objc func successfulPurchaseFoodRation1900() {
        
        buttonRestoredPurchase.zoomOutInfo()
        buttonPurchaseFoodRation1900.zoomOutInfo()
        
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
            self.buttonRestoredPurchase.isHidden = true
            self.buttonPurchaseFoodRation1900.isHidden = true
        }
    }
...
//MARK: - ButtonPurchase
    lazy var buttonPurchaseFoodRation1900: UIButton = {
        var width: CGFloat!
    ...
    @objc func buttonPurchaseFoodRation1900(sender: UIButton) {
        activityIndicator.startAnimating()
        
        SwiftyStoreKit.purchaseProduct("com.transform.fitness.foodRation1900", quantity: 1, atomically: true) { result in
            switch result {
            case .success(let purchase):
                
                UserDefaults.standard.set(true, forKey: "foodRation1900_purchased")
                
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "successfulPurchaseFoodRation1900"), object: nil)
...
//MARK: - ButtonMenu
    ...
    @objc func button1Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Monday")
    ...
    @objc func button2Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Tuesday")
    
        if !foodRation1900_purchased {
    ...
    @objc func button3Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Wednesday")
    ...
    @objc func button4Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Thursday")
    ...
    @objc func button5Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Friday")
    ...
    @objc func button6Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Saturday")
    ...
    @objc func button7Action(sender: UIButton) {
        ...
        imageDay1.image = #imageLiteral(resourceName: "foodRation1900Sunday")
