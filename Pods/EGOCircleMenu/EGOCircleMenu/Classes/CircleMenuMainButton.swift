...
public class CircleMenuMainButton: BasicCircleMenuButton {
    static let size = 60 // HamburgerCornerRadius / position (52)
    private let animationViewSize = 40 //24  HamburgerSize
    private let startScale: CGFloat = 0.6 // 0.85
    private let endScale: CGFloat = 1.0 // 1.0
    ...
    public override init(frame: CGRect) {
        ...
        mainButtonAnimationView.layer.zPosition = 101
